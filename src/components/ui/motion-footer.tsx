...
.cinematic-footer-wrapper {
  ...
  --pill-bg-1-hover: color-mix(in oklch, var(--accent-main) 20%, transparent);
  --pill-bg-2-hover: color-mix(in oklch, var(--accent-main) 5%, transparent);
  --pill-border-hover: color-mix(in oklch, var(--accent-main) 40%, transparent);
  --pill-shadow-hover: color-mix(in oklch, var(--accent-main) 30%, transparent);
...
@keyframes footer-heartbeat {
  0%, 100% { transform: scale(1); filter: drop-shadow(0 0 5px color-mix(in oklch, var(--accent-main) 50%, transparent)); }
  15%, 45% { transform: scale(1.2); filter: drop-shadow(0 0 10px color-mix(in oklch, var(--accent-main) 80%, transparent)); }
      ...
      >
        ...
        <footer className="fixed bottom-0 left-0 flex h-screen w-full flex-col justify-between overflow-hidden bg-[var(--surface-base)] text-[var(--foreground)] cinematic-footer-wrapper">
          ...
          <div className="relative z-20 w-full pb-8 px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            {/* Copyright */}
            <div className="text-[var(--text-muted)] text-[10px] md:text-xs font-semibold tracking-widest uppercase order-2 md:order-1 font-display">
              © 2026 DOOM OTT Platform. All rights reserved.
            </div>
            ...
            <div className="footer-glass-pill px-6 py-3 rounded-full flex items-center gap-2 order-1 md:order-2 cursor-default border-[var(--border)]">
              <span className="text-[var(--text-muted)] text-[10px] md:text-xs font-bold uppercase tracking-widest">Crafted with</span>
              <span className="animate-footer-heartbeat text-sm md:text-base text-[var(--accent-main)]">🔥</span>
              <span className="text-[var(--text-muted)] text-[10px] md:text-xs font-bold uppercase tracking-widest">by</span>
              <span className="text-[var(--foreground)] font-black text-xs md:text-sm tracking-normal ml-1">DOOM OTT</span>
            </div>
